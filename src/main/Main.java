...
public class Main {
	...
	public static void main(String[] args) {
		...
		// livros fisicos
		LivroFisico lf1 = new LivroFisico("Livro Físico Aprendendo JAVA", "CAFEO, B.", "Ed. UNICAMP", "PT-BR",
				LocalDate.of(2023, 8, 1), "Material Didático", "Livro sobre os conteitos básicos de OO em JAVA", "CAPA",
				false, false, 8, 8, "aass336541", 1, "Estante A, Fileira 1", "NOVO");
		// armazenamento do material
		ArmazenamentoBiblioteca.getLivrosFisicos().add(lf1);

		// livros digitais
		LivroDigital ld1 = new LivroDigital("Livro digital Aprendendo JAVA", "CAFEO, B.", "Ed. UNICAMP", "PT-BR",
				LocalDate.of(2023, 8, 1), "Material Didático", "Livro sobre os conteitos básicos de OO em JAVA", "CAPA",
				false, false, 20, 20, "PDF", "unicamp.br", "PC", LocalDate.of(2023, 8, 1));
		...
		// Outros recursos
		OutroRecursoMultimidia or1 = new OutroRecursoMultimidia("Banner: Aprendendo JAVA", "CAFEO, B.", "Ed. UNICAMP",
				"PT-BR", LocalDate.of(2023, 8, 1), "Material Didático",
				"Livro sobre os conteitos básicos de OO em JAVA", "CAPA", false, false, 1, 1, "Banner", "Banner",
				"Galpao principal", "Semi Novo");
...
//		}
		...
		EstudanteGrad eg1 = new EstudanteGrad("Victor Silva", "206574", "Rua a n° 1", "v206574@dac.unicamp.br",
				LocalDate.of(2017, 03, 01));
		ArmazenamentoBiblioteca.getEstudantesGrad().add(eg1);
		EstudantePos ep1 = new EstudantePos("jose gomes", "111111", "Rua b n° 2", "joseg@gmail.com",
				LocalDate.of(2020, 05, 12));
		ArmazenamentoBiblioteca.getEstudantesPos().add(ep1);
		Professor p1 = new Professor("Bruno Cafeo", "222222", "Rua C n° 3", "cafeo@unicamp.br",
				LocalDate.of(2015, 02, 10));
		ArmazenamentoBiblioteca.getProfessores().add(p1);
		Funcionario f1 = new Funcionario("Ana Luiza", "333333", "Rua D n° 4", "Analuiza@unicamp.br", LocalDate.now(),
				PerfilFuncionario.ADMINISTRADOR);
		ArmazenamentoBiblioteca.getFuncionarios().add(f1);
		Funcionario f2 = new Funcionario("Joao Souza", "444444", "Rua E n° 5", "jsouza@unicamp.br", LocalDate.now(),
		...
		Emprestimo e1 = new Emprestimo("001", StatusEmprestimo.VIGENTE,
		...
		ArmazenamentoBiblioteca.getHistoricoEmprestimos().add(e1);
		// livro digital 1 e dvd 1 para estudante pós
		Emprestimo e2 = new Emprestimo("002", StatusEmprestimo.VIGENTE,
		...
		Emprestimo e3 = new Emprestimo("003", StatusEmprestimo.VIGENTE,
				ArmazenamentoBiblioteca.procurarItemMultimidia("DVD: Aprendendo JAVA"),
				ArmazenamentoBiblioteca.procurarPessoa("111111"), LocalDate.now());
		ArmazenamentoBiblioteca.getHistoricoEmprestimos().add(e2);
		ArmazenamentoBiblioteca.getHistoricoEmprestimos().add(e3);
		// cd1 para professor
		Emprestimo e4 = new Emprestimo("004", StatusEmprestimo.VIGENTE,
		...
		ArmazenamentoBiblioteca.getHistoricoEmprestimos().add(e4);
